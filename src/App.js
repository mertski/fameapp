...
function App() {
  ...
  const handleEditSelection = (edit) => {
    ...
    if (targetAge < 18) {
      return `Age this person to ${targetAge} years old: Keep the exact same face shape, eye shape, nose, lips, and facial structure. Only apply: completely smooth skin with no wrinkles, youthful skin texture, healthy skin tone. ${corePreservation} Maintain all distinctive facial features and natural lighting.`;
    } else if (targetAge >= 18 && targetAge <= 30) {
      return `Age this person to ${targetAge} years old: Keep the exact same face shape, eye shape, nose, lips, and facial structure. Only apply: clear smooth skin, minimal skin texture, no wrinkles, healthy complexion. Keep existing facial hair style if present. ${corePreservation} Natural lighting and photorealistic quality.`;
    } else if (targetAge >= 31 && targetAge <= 50) {
      return `Age this person to ${targetAge} years old: Keep the exact same face shape, eye shape, nose, lips, and facial structure. Only add aging effects: subtle crow's feet wrinkles around eyes, light forehead lines, beginning smile lines, skin texture with mild aging. If facial hair exists, keep same style but add 10-30% gray/white color. ${corePreservation} Natural aging with realistic lighting.`;
    } else if (targetAge >= 51 && targetAge <= 70) {
      return `Age this person to ${targetAge} years old: Keep the exact same face shape, eye shape, nose, lips, and facial structure. Only add aging effects: pronounced crow's feet wrinkles around eyes, visible forehead wrinkles, deeper smile lines, slight eyelid drooping, skin texture with natural aging. If facial hair exists, keep same style but make 50-80% gray/white color. Add some scattered facial hair for aging effect. ${corePreservation} Realistic aging progression.`;
    } else {
      return `Age this person to ${targetAge} years old: Keep the exact same face shape, eye shape, nose, lips, and facial structure. Only add aging effects: deep crow's feet wrinkles around eyes, pronounced forehead wrinkles, deeper smile lines, drooping eyelids, aged skin texture with age spots. If facial hair exists, keep same style but make mostly gray/white color and add scattered facial hair for elderly appearance. ${corePreservation} Advanced natural aging with realistic lighting.`;
    }
  };
